...
startYear, startMonth,startDay = (2007,8,23)
endYear, endMonth,endDay = (2018,10,10)
...
#df_model.query('Q98_pred == 1')    #Tool to do a query in the df_model
 ...
 #%% trial : computation hits, misses, false_al and corr_neg for Katakwi

#for i in df_model.index : 
 #   if df_model.loc[i].flood=1 and df_model.loc[i].Q50_pred=1 :
